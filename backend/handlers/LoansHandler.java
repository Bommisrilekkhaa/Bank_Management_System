...
public class LoansHandler {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (queryParamMap.containsKey("filter_type")) {
            ControllerServlet.pathMap.put("l.loan_type",
                    Integer.valueOf(LoanType.valueOf(queryParamMap.get("filter_type")[0].toUpperCase()).getValue()));

        }
        if (queryParamMap.containsKey("filter_status")) {
            ControllerServlet.pathMap.put("l.loan_status", Integer
                    .valueOf(LoanStatus.valueOf(queryParamMap.get("filter_status")[0].toUpperCase()).getValue()));
        ...
        if (cachedData != null) {
            ...
            try {
                ...
                if (ControllerServlet.pathMap.containsKey(Resources.LOANS.toString().toLowerCase())) {
                ...
                if (!loans.isEmpty()) {
                    for (Loan loan : loans) {
                        ...
                        loanJson.addProperty("loan_type",
                                LoanType.valueOf(loan.getLoan_type()).toString().toLowerCase());
                        ...
                        loanJson.addProperty("loan_status",
                                LoanStatus.valueOf(loan.getLoan_status()).toString().toLowerCase());
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            newLoan.setAcc_no(ControllerServlet.pathMap.get(Resources.ACCOUNTS.toString().toLowerCase()));
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            updatedLoan.setAcc_no(ControllerServlet.pathMap.get(Resources.ACCOUNTS.toString().toLowerCase()));
            updatedLoan.setLoan_id(ControllerServlet.pathMap.get(Resources.LOANS.toString().toLowerCase()));
            ...
            if (checkAccountStatus(conn, updatedLoan)) {
                ...
                if(updatedLoan.getLoan_status()==LoanStatus.CLOSED.getValue())
                {
                	if(!loanDAO.preclosure(conn,updatedLoan))
                	{
    ...
    private boolean checkAccountStatus(Connection conn, Loan loan) throws SQLException {
        ...
        accountMap.put(Resources.ACCOUNTS.toString().toLowerCase(), loan.getAcc_no());
